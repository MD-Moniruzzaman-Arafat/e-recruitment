...
export default function PageBanner({ title, description }) {
    return (
        <>
            <div className='max-w-[1728px] h-[449px] mx-auto md:px-20 flex flex-col md:flex-row justify-between items-center' style={{ backgroundImage: ` url(${bannerBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
