...
export default function AppliedJob({ length }) {
    return (
        <>
            <div className='max-w-[1728px] mx-auto px-2 md:px-20 my-15'>
                <div className='flex justify-between items-center'>
                    <h1 className='text-[15px] md:text-[32px] font-bold text-[#636E72]'>Applied <span className='text-[#0984E3]'>Jobs</span></h1>
                ...
                <div>
                    <div className="card-actions flex items-center justify-center md:justify-end">
