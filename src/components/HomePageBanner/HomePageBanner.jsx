...
export default function HomePageBanner() {
    return (
        <>
            <div className='max-w-[1728px] h-[712px] mx-auto flex flex-col md:flex-row justify-around items-center p-4 bg-white shadow-md' style={{ backgroundImage: ` url(${bannerBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
